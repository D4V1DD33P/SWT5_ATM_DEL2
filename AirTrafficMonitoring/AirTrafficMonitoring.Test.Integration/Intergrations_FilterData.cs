...
//            _creatingFakeTrackData3 = new TrackData
//            {
//                Tag = "JAS002",
//                X = 20000,
//                Y = 20000,
...
//            _creatingFakeTrackData4 = new TrackData
//            {
//                Tag = "JAS002",
//                X = 10000,
//                Y = 10000,
...
//        {
//            _creatingFakeTrackDataList.Clear();
//            _creatingFakeTrackDataList.Add(_creatingFakeTrackData4);
//            _filteringData.ConfirmTracks(_creatingFakeTrackDataList);

//            _creatingFakeTrackDataList.Clear();
//            _creatingFakeTrackDataList.Add(_creatingFakeTrackData3);

//            _filteringData.ConfirmTracks(_creatingFakeTrackDataList);

//            _trackDataRendition.Received().Print(Arg.Is<List<ITrackData>>(data => data[0].Tag == "JAS002" && data[0].Course == (int)225));
//        }
